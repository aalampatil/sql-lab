...
function Navbar() {
  ...
  return (
    <>
      <nav className="bg-white border-b border-orange-300">
        <div className="flex flex-col items-center justify-start gap-3 p-3 sm:flex-row sm:justify-between sm:items-center">
          ...
          <div className="text-orange-600 border border-orange-400 flex items-center justify-end m-1 p-1 rouned-md">
            <button
              className="cursor-pointer"
              onClick={() => navigate("/assignment-page")}
            >
              Open Sql Lab
            </button>
          </div>
          <button className="bg-orange-500 px-4 py-2 rounded-lg font-bold text-sm text-white hover:bg-orange-600 transition-colors">
            Sign in
          </button>
        </div>
      </nav>
